...
import static net.mahdilamb.rtree.Node2D.distBBox;
import static net.mahdilamb.rtree.Node2D.union;
import static net.mahdilamb.rtree.Node2DImpl.enlargedArea;
import static net.mahdilamb.rtree.Node2DImpl.intersectionArea;
